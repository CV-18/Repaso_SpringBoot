...
public class AlbumMapper {
    public Album toAlbum(AlbumCreateDto albumCreateDto){
        return Album.builder()
                ...
                .discografica(albumCreateDto.getDiscografica())
    ...
    public Album toAlbum(AlbumUpdateDto albumUpdateDto, Album album){
        return Album.builder()
                ...
                .discografica(albumUpdateDto.getDiscografica() != null ? albumUpdateDto.getDiscografica() : album.getDiscografica())
