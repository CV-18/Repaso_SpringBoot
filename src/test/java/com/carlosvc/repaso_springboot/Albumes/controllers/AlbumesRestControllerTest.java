...
class AlbumesRestControllerTest {
    ...
    @Test
    void getAll() {
        var albumResponseDto = List.of(albumResponseDto1, albumResponseDto2);
        when(albumesService.findAll(null, null)).thenReturn(albumResponseDto);
    ...
    void getAllByNombre(){
        ...
        verify(albumesService,times(1)).findAll(anyString(), isNull());
