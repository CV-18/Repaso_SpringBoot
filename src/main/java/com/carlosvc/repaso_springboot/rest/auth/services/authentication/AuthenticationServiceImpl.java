...
import com.carlosvc.repaso_springboot.rest.users.models.Role;
...
public class AuthenticationServiceImpl implements  AuthenticationService {
    private final AuthUsersRepository authUserRepository;
    ...
    public JwtAuthResponse signUp(UserSignUpRequest request) {
        ...
        if (request.getPassword().contentEquals(request.getPasswordComprobacion())){
            ...
            try {
                ...
                throw new AuthExistingUsernameOrEmail("EL usuario con username: " +request.getUsername() + " o email: " + request.getEmail());
            }
